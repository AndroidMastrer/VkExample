...
public class Post implements Parcelable, Comparable<Post> {
	...
	public void writeToParcel(Parcel dest, int flags) {
		...
		dest.writeParcelableArray(copyHistoreArray, flags);
		dest.writeParcelableArray(attachmentsArray, flags);
	}
	...
	private Post(Parcel in) {
		...
		in.readParcelableArray(Post.class.getClassLoader());
		copyHistoreArray = (Post[]) in.readParcelableArray(Post.class
				.getClassLoader());
		attachmentsArray = (Attachment[]) in
				.readParcelableArray(Attachment.class.getClassLoader());
	}
