...
public class VKAttachmentsDBHelper {
	...
	public static void addAttachments(Collection<Attachment> Attachments) {
		try {
			final Dao<Attachment, Integer> AttachmentDao = VKDatabaseHelper
					.getDatabaseHelper().getAttachmentDao();
	...
	public static List<Attachment> getAttachmentList() {
		...
		try {
			final Dao<Attachment, Integer> AttachmentsDao = VKDatabaseHelper
					.getDatabaseHelper().getAttachmentDao();
