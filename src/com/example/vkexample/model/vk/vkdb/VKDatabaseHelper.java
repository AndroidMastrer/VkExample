...
public class VKDatabaseHelper extends DatabaseHelper {
	...
	@Override
	protected void clearTables(AndroidConnectionSource connectionSource)
			throws SQLException {
	...
	public static void createDBHelper(Context applicationContext) {
		if (databaseHelper == null)
			databaseHelper = OpenHelperManager.getHelper(applicationContext,
					VKDatabaseHelper.class);
	}
